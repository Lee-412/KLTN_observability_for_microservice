...
| Ours (MicroRank + Stream v2.3) | 15.87 | 8.57 | 11.81 | 57.94 | 22.64 | 25.57 | 0.3944 | 0.2130 | 0.2617 |

## Notes
- Paper model rows are copied from Table 3 screenshot provided in this chat.
- Ours (Hybrid) and Ours (Stream v1 strictfix) rows are preserved from prior comparison artifacts.
- Ours (Stream v2.3) row uses macro-average over 3 datasets from: rca-paper-table-sampled-budgets-stream-v2_3-paper-0p1-1-2p5-20260405-222114.csv.
