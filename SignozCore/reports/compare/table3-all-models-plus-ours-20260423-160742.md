...
| Ours (MicroRank + stream-v3.94.1-metric-native-consensus) | 25.80 | 24.04 | 19.65 | 48.57 | 51.45 | 51.33 | 0.4296 | 0.4193 | 0.4072 |
...
- Current run row is generated automatically from this run with selection-mode=stream-v3.94.1-metric-native-consensus.
