...
| Ours (MicroRank + stream-v3.52-service-coverage) | 0.00 | 0.00 | 18.75 | 0.00 | 0.00 | 46.88 | 0.0000 | 0.0000 | 0.3943 |
...
- Current run row is generated automatically from this run with selection-mode=stream-v3.52-service-coverage.
