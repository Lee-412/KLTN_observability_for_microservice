...
- Ours (Hybrid) row is preserved from prior comparison.
- Ours (Stream v1 strictfix) row uses macro-average over 3 datasets from tag: 20260405-stream-v1-strictfix-paper-0p1-1-2p5.
