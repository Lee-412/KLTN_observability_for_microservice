...
| Ours (MicroRank + stream-v3.92-service-coverage) | 0.00 | 0.00 | 21.88 | 0.00 | 0.00 | 46.88 | 0.0000 | 0.0000 | 0.4151 |
...
- Current run row is generated automatically from this run with selection-mode=stream-v3.92-service-coverage.
