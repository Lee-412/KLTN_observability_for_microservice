...
- Phase1 sampled traces + kept trace IDs:
  - reports/analysis/paper-sampled-traces/20260403-smoke-10/<dataset>/<budget_slug>/trace/*.csv
  - reports/analysis/paper-sampled-traces/20260403-smoke-10/<dataset>/<budget_slug>/kept_trace_ids.txt
- Phase1 combined-style metric file:
  - reports/compare/paper-sampling-phase1-<dataset>-<budget_slug>-20260403-smoke-10.txt
- Phase2 benchmark table (teacher-facing):
  - /home/leeduc/Desktop/KLTN/SignozCore/reports/compare/rca-paper-table-sampled-budgets-20260403-smoke-10.csv
- Phase2 compare with paper (csv + markdown):
  - /home/leeduc/Desktop/KLTN/SignozCore/reports/compare/rca-paper-vs-ours-microrank-budgets-20260403-smoke-10.csv
  - /home/leeduc/Desktop/KLTN/SignozCore/reports/compare/rca-paper-vs-ours-microrank-budgets-20260403-smoke-10.md
