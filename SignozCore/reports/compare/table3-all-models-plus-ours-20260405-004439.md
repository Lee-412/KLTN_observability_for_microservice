...
- Ours row uses macro-average over 3 datasets (train-ticket, hipster-batch1, hipster-batch2) from the existing run; old artifacts were kept unchanged.
