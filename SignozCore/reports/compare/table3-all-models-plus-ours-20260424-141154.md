...
| Ours (MicroRank + stream-v3.94.2-metric-native-signed-contrast) | 32.39 | 16.89 | 13.89 | 45.34 | 46.83 | 39.44 | 0.4587 | 0.3590 | 0.3309 |
...
- Current run row is generated automatically from this run with selection-mode=stream-v3.94.2-metric-native-signed-contrast.
