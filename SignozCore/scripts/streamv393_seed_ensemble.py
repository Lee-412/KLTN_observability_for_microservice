"""
Stream v3.93 -- seed-robust ensemble on v3.9 baseline.

Runs the v3.9 tuned RCA sampler with 5 different seeds, unions all
kept sets, then trims to target_count by rca_rank_key. This reduces
random seed variance which is dominant at 0.1% budget (~10 traces).
"""

from typing import Any, Set, List, Tuple, Dict, Optional

import streamv39_tuned_rca as sv39comp
from streamv39_tuned_rca import TracePoint, PreferenceVector, MetricStats, build_metric_inputs, _clamp


def _composite_v393_seed_ensemble(
